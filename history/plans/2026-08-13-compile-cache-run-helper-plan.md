...
**Design doc:** `history/plans/2026-08-13-compile-cache-run-helper-design.md`
...
- [ ] `grep -rn "sourceLen + 1\|wrappedSource.size() + 1" lib/` returns nothing -- the bare terminator arithmetic is gone from the tree.
