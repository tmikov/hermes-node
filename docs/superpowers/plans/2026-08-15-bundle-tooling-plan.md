...
**Spec:** `docs/superpowers/specs/2026-08-15-bundle-tooling-design.md`
...
- Create: `docs/superpowers/plans/progress-bundle-tooling.md`
...
`docs/superpowers/plans/progress-bundle-tooling.md`, naming this plan, with a table
of the six tasks and their status, matching the format of
`docs/superpowers/plans/progress-aot-bundle.md`.
...
./utils/format.sh --check
cmake --build cmake-build-asan --target check-hermes-node
git add tools/hermes-node README.md CLAUDE.md docs/superpowers/plans/progress-bundle-tooling.md test/bundle-tool-errors.js
