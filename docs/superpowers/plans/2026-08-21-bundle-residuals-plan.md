...
`docs/superpowers/specs/2026-08-19-closed-world-bundle-design.md`. Subsystem progress:
`docs/superpowers/plans/progress-aot-bundle.md` (append there at the end; do not start
a new progress file).
...
Append to `docs/superpowers/plans/progress-aot-bundle.md`: what each of the fourteen
