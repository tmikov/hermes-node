...
**Spec:** `history/plans/2026-08-20-bundle-preload-design.md`. Read it —
this plan argues from it, and the rationale for every decision is there.
Background: `history/plans/2026-08-19-closed-world-bundle-design.md`.
Progress: append outcomes to `history/plans/progress-aot-bundle.md`.
...
Append to `history/plans/progress-aot-bundle.md`: what shipped, that this
...
```bash
./utils/format.sh -f
git add tools/hermes-node CLAUDE.md history/plans test/bundle-errors.js
