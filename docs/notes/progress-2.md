...
Tracks progress on `docs/superpowers/plans/2026-02-15-async-generators-fix-plan.md`.
...
- **Files**: modified `docs/notes/issues-and-workarounds.md`, `docs/notes/memory.md`, `docs/notes/progress.md`
