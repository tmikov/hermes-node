...
**Design doc:** `docs/superpowers/specs/2026-08-12-bytecode-compile-cache-design.md`
...
**Files:**
- Create: `docs/superpowers/plans/progress-compile-cache.md`
...
Create `docs/superpowers/plans/progress-compile-cache.md` recording: which plan it
...
```bash
cmake --build cmake-build-asan --target check-hermes-node
git add docs/superpowers/plans/progress-compile-cache.md CLAUDE.md
