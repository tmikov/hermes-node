...
**Spec:** `docs/superpowers/specs/2026-08-15-aot-bundle-design.md`
...
**Files:**
- Create: `docs/superpowers/plans/progress-aot-bundle.md`
...
Create `docs/superpowers/plans/progress-aot-bundle.md` naming this plan, with a table
of the eight tasks and their status, matching the format of
`docs/superpowers/plans/progress-compile-cache.md`.
...
./utils/format.sh --check
cmake --build cmake-build-asan --target check-hermes-node
git add docs/superpowers/plans/progress-aot-bundle.md test/bundle-yargs.js test/lit.cfg README.md CLAUDE.md
