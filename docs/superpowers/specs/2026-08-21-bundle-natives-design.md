...
a bundle a closed world, and `docs/superpowers/specs/2026-08-20-bundle-preload-design.md`,
...
`docs/superpowers/plans/progress-aot-bundle.md`): `--include`ing an addon can widen
...
transcript is in `docs/superpowers/plans/progress-aot-bundle.md` under
