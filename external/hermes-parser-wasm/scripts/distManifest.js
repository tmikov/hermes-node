...
// Producer and checker for hermes-parser's dist build manifest.
//
// hermes-parser ships `main: dist/index.js`, and upstream treats `dist/`
// as a gitignored build output that nothing regenerates automatically. Anything
...
//
// regen-dist.sh calls this file after it finishes assembling `dist/`,
...
const REBUILD_COMMAND =
  'external/hermes-parser-wasm/scripts/regen-dist.sh ' +
  '<path-to-hermes-parser-wasm.js>';
