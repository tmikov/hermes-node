...
**Spec:** `docs/superpowers/specs/2026-08-23-single-executable-design.md`
...
| `docs/superpowers/plans/progress-single-executable.md` | Created and updated per task. |
...
Naming the plan it tracks, per the convention in `docs/notes/README.md` and the
