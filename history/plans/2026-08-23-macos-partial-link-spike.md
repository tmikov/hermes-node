...
- **Deliverable:** fill in and commit `history/plans/2026-08-23-macos-partial-link-results.md`
...
- **Commit only** `history/plans/2026-08-23-macos-partial-link-results.md`
...
Create `history/plans/2026-08-23-macos-partial-link-results.md` with this shape
and commit it.
