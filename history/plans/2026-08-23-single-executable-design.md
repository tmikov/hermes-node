...
Follows `history/plans/2026-08-15-aot-bundle-design.md` and the rounds after
...
`history/plans/2026-08-23-macos-partial-link-spike.md` (handoff) and
`history/plans/2026-08-23-macos-partial-link-results.md` (measurements).
