...
- **Deliverable:** the feature **working** on this machine, fixes committed,
  plus a report at `docs/notes/2026-08-24-macos-validation-results.md`
...
Prior work on this machine: `docs/notes/2026-08-23-macos-partial-link-spike.md`
...
`docs/notes/2026-08-24-macos-validation-results.md`:
