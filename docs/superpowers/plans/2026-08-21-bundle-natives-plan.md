...
**Spec:** `docs/superpowers/specs/2026-08-21-bundle-natives-design.md`
...
- `CLAUDE.md`, `docs/superpowers/plans/progress-aot-bundle.md`.
...
git add include/hermes/node-compat/bundle/bundle_format.h \
        ...
        docs/superpowers/specs/2026-08-21-bundle-natives-design.md
...
Append a dated section to `docs/superpowers/plans/progress-aot-bundle.md` covering:
...
```bash
git add CLAUDE.md docs/superpowers/plans/progress-aot-bundle.md
