...
Tracks progress on `docs/superpowers/plans/2026-08-23-single-executable-plan.md`
(implementation plan) and its companion design doc
`docs/superpowers/specs/2026-08-23-single-executable-design.md`. The spike the design
