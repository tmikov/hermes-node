...
Design: `history/plans/2026-08-19-closed-world-bundle-design.md`.
Progress: `history/plans/progress-aot-bundle.md` (same subsystem; append,
...
- Modify: `CLAUDE.md`, `history/plans/progress-aot-bundle.md`,
